...
// Validate checks the field values on GetAllCurrenciesRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetAllCurrenciesRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetAllCurrenciesRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetAllCurrenciesRequestMultiError, or nil if none found.
func (m *GetAllCurrenciesRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *GetAllCurrenciesRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return GetAllCurrenciesRequestMultiError(errors)
	}

	return nil
}

// GetAllCurrenciesRequestMultiError is an error wrapping multiple validation
// errors returned by GetAllCurrenciesRequest.ValidateAll() if the designated
// constraints aren't met.
type GetAllCurrenciesRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetAllCurrenciesRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetAllCurrenciesRequestMultiError) AllErrors() []error { return m }

// GetAllCurrenciesRequestValidationError is the validation error returned by
// GetAllCurrenciesRequest.Validate if the designated constraints aren't met.
type GetAllCurrenciesRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetAllCurrenciesRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetAllCurrenciesRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetAllCurrenciesRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetAllCurrenciesRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetAllCurrenciesRequestValidationError) ErrorName() string {
	return "GetAllCurrenciesRequestValidationError"
}

// Error satisfies the builtin error interface
func (e GetAllCurrenciesRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetAllCurrenciesRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetAllCurrenciesRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetAllCurrenciesRequestValidationError{}

// Validate checks the field values on GetAllCurrenciesResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetAllCurrenciesResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetAllCurrenciesResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetAllCurrenciesResponseMultiError, or nil if none found.
func (m *GetAllCurrenciesResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *GetAllCurrenciesResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return GetAllCurrenciesResponseMultiError(errors)
	}

	return nil
}

// GetAllCurrenciesResponseMultiError is an error wrapping multiple validation
// errors returned by GetAllCurrenciesResponse.ValidateAll() if the designated
// constraints aren't met.
type GetAllCurrenciesResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetAllCurrenciesResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetAllCurrenciesResponseMultiError) AllErrors() []error { return m }

// GetAllCurrenciesResponseValidationError is the validation error returned by
// GetAllCurrenciesResponse.Validate if the designated constraints aren't met.
type GetAllCurrenciesResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetAllCurrenciesResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetAllCurrenciesResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetAllCurrenciesResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetAllCurrenciesResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetAllCurrenciesResponseValidationError) ErrorName() string {
	return "GetAllCurrenciesResponseValidationError"
}

// Error satisfies the builtin error interface
func (e GetAllCurrenciesResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetAllCurrenciesResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetAllCurrenciesResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetAllCurrenciesResponseValidationError{}
