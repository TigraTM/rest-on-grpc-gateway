...
// Validate checks the field values on UserByIDRequest with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *UserByIDRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on UserByIDRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// UserByIDRequestMultiError, or nil if none found.
func (m *UserByIDRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *UserByIDRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return UserByIDRequestMultiError(errors)
	}

	return nil
}

// UserByIDRequestMultiError is an error wrapping multiple validation errors
// returned by UserByIDRequest.ValidateAll() if the designated constraints
// aren't met.
type UserByIDRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m UserByIDRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m UserByIDRequestMultiError) AllErrors() []error { return m }

// UserByIDRequestValidationError is the validation error returned by
// UserByIDRequest.Validate if the designated constraints aren't met.
type UserByIDRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e UserByIDRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UserByIDRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UserByIDRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UserByIDRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UserByIDRequestValidationError) ErrorName() string { return "UserByIDRequestValidationError" }

// Error satisfies the builtin error interface
func (e UserByIDRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sUserByIDRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = UserByIDRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = UserByIDRequestValidationError{}

// Validate checks the field values on UserByIDResponse with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *UserByIDResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on UserByIDResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// UserByIDResponseMultiError, or nil if none found.
func (m *UserByIDResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *UserByIDResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, UserByIDResponseValidationError{
					field:  "User",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return UserByIDResponseValidationError{
				field:  "User",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return UserByIDResponseMultiError(errors)
	}

	return nil
}

// UserByIDResponseMultiError is an error wrapping multiple validation errors
// returned by UserByIDResponse.ValidateAll() if the designated constraints
// aren't met.
type UserByIDResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m UserByIDResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m UserByIDResponseMultiError) AllErrors() []error { return m }

// UserByIDResponseValidationError is the validation error returned by
// UserByIDResponse.Validate if the designated constraints aren't met.
type UserByIDResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e UserByIDResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UserByIDResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UserByIDResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UserByIDResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UserByIDResponseValidationError) ErrorName() string { return "UserByIDResponseValidationError" }

// Error satisfies the builtin error interface
func (e UserByIDResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sUserByIDResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = UserByIDResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = UserByIDResponseValidationError{}
